  ...
  return (
    <Link href={props.href}>
      <div class={"h-60 flex flex-col justify-center"}>
        { props.difficulty ? <p class={"relative text-white top-11 left-3 z-10"}>Difficulty: {props.difficulty}</p> : <Divider class={"my-2"}/> }
        <img src={props.backgroundImage} class={twMerge("mt-3 rounded-xl w-fit h-auto brightness-[0.65]")} />
