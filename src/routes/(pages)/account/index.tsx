    ...
    <>
      <Header text="Account Settings" hasButton={false} />
        ...
        <div class="bg-white rounded overflow-hidden shadow-lg">
          ...
          <div class="">
            <SettingOption class="px-4 py-2 hover:bg-gray-100 flex mt-5" textColor="text-red-500" title="Reset Wallet" onClick$={()=> console.log("Reset Wallet Clicked")}/>
            <SettingOption class="px-4 py-2 hover:bg-gray-100 flex mb-3" title="Logout" onClick$={()=> console.log("Logout Clicked")}/>  
          </div>
        </div>
