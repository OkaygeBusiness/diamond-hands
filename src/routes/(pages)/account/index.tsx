    ...
    <>
      ...
      <div class="bg-white rounded overflow-hidden shadow-lg">
        <div class="text-center p-6  border-b">
          ...
          <div class="mt-5">
            <Button
              class="border rounded-full py-2 px-4 mx-auto"
        ...
        <div class="border-b">
          {/* Reset Wallet Modal Popup If Active */}
          {state.resetActive ? (
            <Modal
              title="Reset Wallet?"
              content="If you reset your wallet, you will lose all progress."
              buttonConfirm="Reset Wallet"
              cancelOnClick$={() => console.log("Cancel Clicked")}
              confirmOnClick$={() => console.log("Reset Wallet Clicked")}
            />
          ):null}

          {/* Logout Modal Popup If Active */}
          {state.logoutActive ? (
            <Modal
              title="Logout"
              ...
              cancelOnClick$={() => console.log("Cancel Clicked")}
              confirmOnClick$={() => console.log("Logout Clicked")}
            />
          ):null}
        ...
        <div class="">
          <SettingOption
            class="px-4 py-2 hover:bg-gray-100 flex block w-full mt-5"
            textColor="text-red-500"
            title="Reset Wallet"
            onClick$={() => (state.resetActive = !state.resetActive)}
          />
          <SettingOption class="px-4 py-2 hover:bg-gray-100 flex block w-full mb-3" title="Logout" onClick$={() => (state.logoutActive = !state.logoutActive)} />
        </div>
      </div>
    </>
  )
